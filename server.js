...
function recalculateRates() {
  ...
  matchState.rrr = calculateRRR(matchState.score, matchState.target, totalBalls, matchState.matchType);
}
...
io.on('connection', (socket) => {
  ...
  socket.on('updateState', (payload) => {
    ...
    if (payload.innings === 2 && matchState.innings === 1) {
      ...
      matchState.target = matchState.team1Score > 0 || matchState.team2Score > 0
